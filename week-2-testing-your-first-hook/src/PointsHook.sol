...
import {ILoaderboard} from "./ILoaderboard.sol";
...
contract PointsHook is BaseHook, ERC1155 {
    ...
    ILoaderboard public mockChainlink;
    ...
    constructor(
        ...
        mockChainlink = ILoaderboard(_mockChainlink);
    }
    ...
    function getGlobalLeaderboard() external view returns (
        ILoaderboard.LeaderboardEntry[] memory
    ) {
